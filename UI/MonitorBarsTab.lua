...
local function BuildBarConfig(container, barCfg, rebuildAll)
    ...
    do
        ...
        if currentAnchor ~= "" then
            ...
            container:AddChild(barAnchorDD)
            ...
            container:AddChild(relAnchorDD)
            ...
            container:AddChild(autoWidthCB)
        end
    end
